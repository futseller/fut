...
rc = requests.get('https://www.ea.com/fifa/ultimate-team/web-app/config/config.json').json()
...
rc = requests.get('https://www.ea.com/fifa/ultimate-team/web-app/content/7D49A6B1-760B-4491-B10C-167FBC81D58A/2019/fut/config/companion/remoteConfig.json').json()
...
card_info_url = 'https://fifa21.content.ea.com/fifa/fltOnlineAssets/7D49A6B1-760B-4491-B10C-167FBC81D58A/2021/fut/items/web/'  # TODO: get hash from somewhere, dynamic year
# TODO: could be nice to add locals on startup
messages_url = 'https://www.ea.com/fifa/ultimate-team/web-app/loc/en_US.json'  # TODO: needs to base64 decoded.
